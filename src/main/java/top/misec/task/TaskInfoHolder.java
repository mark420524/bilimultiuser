...
public class TaskInfoHolder {
    ...
    public static void calculateUpgradeDays(String cookie) {
        if (userInfo == null) {
     ...
     * @return 本日已经投了几个币
     */
    public static int expConfirm(String cookie) {
        JsonObject resultJson = HttpUtil.doGet(ApiList.needCoinNew, cookie);
