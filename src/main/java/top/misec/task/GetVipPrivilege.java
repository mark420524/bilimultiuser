...
public class GetVipPrivilege implements Task {
    ...
    public void run(ConfigUser user) {
        ...
        if (vipType == 1 && day == 1) {
            ...
            JsonObject jsonObject = HttpUtil.doPost(ApiList.mangaGetVipReward, requestBody,user.getUserCookie());
        ...
        if (day == 1 || day % 7 == 0 && vipType == 2) {
            ...
            OftenApi.getVipPrivilege(1, user);
            OftenApi.getVipPrivilege(2, user);
        } else {
