...
public class HttpUtil {
    ...
    public static JsonObject doPost(String url, JsonObject jsonObject,String cookie ) {
        return doPost(url, jsonObject.toString(),cookie);
    }

    public static JsonObject doPost(String url, String requestBody,String cookie ) {
        return doPost(url, requestBody, null,cookie);
    }

    public static JsonObject doPost(String url, String requestBody, Map<String, String> headers,String cookie ) {
    ...
    public static JsonObject doGet(String url,String cookie) {
        return doGet(url, new JsonObject(),cookie);
    }
    ...
    public static JsonObject doGet(String url, JsonObject pJson,String cookie) {
