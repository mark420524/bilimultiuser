...
这是一个利用 BILIBI-HELPER 2.0 多用户版本，参考项目是：[JunzhouLiu/BILIBILI-HELPER](https://github.com/JunzhouLiu/BILIBILI-HELPER) 
...
```
wget setup.sh && chmod +x ./setup.sh && sudo ./setup.sh
```
...
[30]: https://github.com/mark420524/bilimultiuser/releases/latest
[31]: start.sh
...
echo $PATH
java -jar /home/BILIBILI-HELPER.jar   >> /var/log/bilibili-help.log
...
30 10 * * * java -jar /home/BILIBILI-HELP.jar   >/var/log/cron.log &
```
...
| pushMsg           | [false,true]         | 是否开启任务推送，默认开启，如需关闭请改为 false                   |
| users              | array            | 多用户配置|
